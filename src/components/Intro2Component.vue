...
const neonText= ref('una experiencia <br>recargada');
const neonTextHtml = ref(neonText.value);
...
onMounted(() => {
    ...
    tl.to(".text-neon", {
      ...
      .to(".text-neon", {
        ...
        delay: 0.8,
        onComplete: () => {
            neonTextHtml.value =  neonTextHtml.value === neonText.value ? 'una descarga <br>de Adrenalina' : neonText.value;
        },
      })
      .to(".text-neon", {
        duration: 0.4,
...
<template>
      <div class="flex   max-[767px]:flex-col">
          <div class=" w-7/12  justify-end items-center  max-[767px]:w-full max-[767px]:justify-center max-[767px]:py-10">
           ...
           <p class=" text-primaryLight text-neon text-5xl text-center font-bold uppercase" v-html="neonTextHtml"> </p>
           <div class="flex justify-between flex-col w-full ">
              <div class="flex justify-center items-center  ">
                <div
                  class="px-20 text-white my-10 text-start  text-lg min-[1500px]:text-xl max-[767px]:w-full max-[767px]:text-sm" >
                  <p>
          ...
          <div class="w-5/12 flex justify-start items-center max-[767px]:w-full">
            <img src="@/assets/images/eyes-dino-home.jpg" alt="" srcset="" class="  max-[767px]:w-full eye-dino" />
          </div>
        </div>
</template>
...
<style scoped>
.text-neon{
    -webkit-text-shadow: 0px 0px 15px 5px rgba(255, 255, 255, 0.35); 
    text-shadow: 0px 0px 17px rgba(0, 255, 255, 1);
    word-spacing: 0.5rem;
}
.eye-dino{
    width: 100%;
